...
openai.api_key = "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"
...
@bot.tree.command(name="help",
                  description="Hit enter to know more about the bot")
@app_commands.describe(partinfo="Details about any one part among 22 parts",
                       articleinfo="Details of any individual article")
async def help(interaction: Interaction,
               partinfo: Optional[int] = None,
               articleinfo: Optional[str] = None):

  if partinfo is None and articleinfo is None:
...
📚 **Examples:**
- `/help partinfo: 5` - Get more info about Part V.
- `/help partinfo: -1` - Receive a complete list of the Constitution.
- `/help articleinfo: 51A` - Get more info about article 51A.

🌐 **Explore and Learn!**
''')

  elif partinfo is not None and partinfo >= 0 and partinfo < 23:
    info = details_parts[partinfo]["tags"]
    prompt = details_parts[partinfo]["Title"]
    ...
    info2 = f"\nTo know the details of {details_parts[partinfo]['Title']}, visit here https://www.clearias.com/constitution-of-india/{info}" + " 🚀✨"
    ...
    await interaction.response.send_message(
        "## :warning: You have entered invalid part number. It ranges from 0-22\n" +
        message)
